function validarDadosCliente() {
    ...
    if (form.name.value.length < 3 || form.name.value == "") {
        var alert = document.getElementById("alert-wrapper-name");
        form.name.focus()
    ...
    if (form.email.value.indexOf('@') == -1 || form.email.value.indexOf('.') == -1 || form.email.value == "") {
        var alert = document.getElementById("alert-wrapper-email");
        form.email.focus()
    ...
    if(form.obs.value.length > 1000){
        var alert = document.getElementById("alert-wrapper-obs");
        form.obs.focus()
